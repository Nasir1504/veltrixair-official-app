        ...
        >
            <div className='w-full h-[60px] shrink-0 flex justify-center gap-[48%] items-center user'>
                <div className="relative w-[70px] h-full flex justify-start items-center ">
                    <div
                        className=" absolute w-[260%] h-[40%] bg-[#00000060] blur-[10px] rounded-full opacity-60"
                    />
                    <Link
    ...
    return (
        <div
            ...
            >
                ...
                >Services</span>
                <span className={`lowercase no-underline
            ...
            >
                ...
                {/* <div className="w-full">
                    ...
                    >
                        ...
                        >Construction</span> <span className={`lowercase no-underline
                                            text-[1rem]
                        `}>&#x3e;</span>
