...
const PeoplePage = () => {
    ...
    return (
        <div className="people-page-main bg-bg8 relative">

            <Helmet>
                <title>Careers in IT Infrastructure & Technology | Veltrixair.</title>
                <meta name="description" content="Explore career opportunities in IT infrastructure, cloud, and cybersecurity. Join a team building scalable, secure, and future-ready technology solutions." />
            </Helmet>

            <div className={`fixed z-0 w-full left-0 top-0 h-[100vh] bg-no-repeat bg-[linear-gradient(90deg,rgba(30,29,29,0.1)0%,rgba(56,56,56,0.1)_71%)] 
                                                overflow-hidden`}
            >
                <div
                    className='absolute z-4 bg-[linear-gradient(90deg,rgba(55,92,165,1)_45%,rgba(112,152,232,1)_51%)] 
