...
const ShutterContent = ({
    ...
    return (
        ...
        >
            ...
            <div className='text-text1 flex flex-col justify-center items-center font-bold text-center max-xs:px-[10%] px-[28%] lg:px-[28%] xl:px-[32%] gap-[2rem]
            ...
            >
                ...
                '>
                    ...
                    <span
                        className='uppercase font-light max-xs:text-[3.5rem] max-xxs:text-[3rem]'
                    >{Heading2}</span>
                </h3>

                <p className='text-center text-text2 font-medium
                            max-xxs:text-[0.85rem] max-xs:text-[1rem] text-[0.75rem] md:text-[0.75rem] mdlg:text-[0.85rem] lg:text-[1rem] xl:text-[1.1rem]
                '>
                    {SubHeading}
                </p>
                {/* -========================================== */}
                <button className='relative z-10 shrink-0 rounded-[5rem] flex overflow-hidden p-0.5 cursor-pointer
                                  ...
                                  text-[1rem] md:text-[1rem] mdlg:text-[1.1rem] lg:text-[1.3rem] xl:text-[1.4rem] font-light tracking-tight [text-shadow:2px_2px_2px_rgba(0,0,0,1)]
