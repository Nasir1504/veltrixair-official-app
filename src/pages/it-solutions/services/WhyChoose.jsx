...
const OUR_CULTURE_BUILD_ON_DATA = [
    ...
    {
        name: "OwneSecure and scalable enterprise infrastructure",
        imgURL: Ownership
    },
    {
    ...
    return (
        <div>
            ...
            <section className='relative max-xs:h-[100vh] h-[500px] md:h-[550px] mdlg:h-[650px] lg:h-[740px] xl:h-[920px] flex flex-col justify-center items-center max-xs:gap-[2%] gap-[4%]'>
                ...
                >
                    <span
                        className="text-text12 max-xxxs:text-[1.4rem] max-xxs:text-[1.6rem] max-xs:text-[1.8rem] text-[1.6rem] md:text-[1.6rem] mdlg:text-[1.8rem] lg:text-[2rem] xl:text-[2.2rem]"
                    >Why Choose</span><br />
                    <span className="font-[Saved_by_zero] text-text1
                                    max-xxxs:text-[1.8rem] max-xxs:text-[2rem] max-xs:text-[2.2rem] text-[2rem] md:text-[2rem] mdlg:text-[2.2rem] lg:text-[2.4rem] xl:text-[2.8rem]
                    ">
                        Veltrixair</span>
                </h3>
                <p className='text-text12 max-xxs:w-[80%] max-xs:w-[65%] w-[50%] text-center 
                    ...
                    {OUR_CULTURE_BUILD_ON_DATA.map((item, i) => {
                        return (
                            ...
                            >
                                ...
                                >
                                    <div className='w-[70%] max-xxs:w-[70%] aspect-square bg-bg3 rounded-[0.6em] md:rounded-[0.6em] mdlg:rounded-[0.7em] lg:rounded-[0.9em] xl:rounded-[1.2rem] max-xxs:p-[15%] p-[20%]'>
                                        <img
                                            src={item.imgURL}
