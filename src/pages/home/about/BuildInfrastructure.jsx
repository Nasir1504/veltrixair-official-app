...
const BuildInfrastructure = ({
    PageName,
    MainHeading1 = "Build Infrastructure",
    MainHeading2 = "That Performs Under Pressure"
}) => {
    ...
    return (
        <div
            className="relative w-full max-xxs:h-[85vh] max-xs:h-screen h-[600px] lg:h-[750px] xl:h-[900px] bg-bg2 flex flex-col items-start justify-between overflow-hidden"
        >
            <div
                ref={exmRef}
                className="relative w-full h-[65%] bg-bg1 max-xs:px-[6%] px-[8%] md:px-[8%] flex flex-col justify-start gap-[10%]"
            >
                <div className="max-xs:h-[2vh] sm:h-[5%]" />
                <div className="max-xs:h-[18%] sm:h-[28%]">
                    <h2
                        className="text-text1 max-xs:text-[4vw] text-[1.7rem] md:text-[1.7rem] lg:text-[2.1rem] xl:text-[2.5rem]"
                    >{MainHeading1}</h2>


                    <h2
                        className="text-text1 max-xs:text-[4vw] text-[1.7rem] md:text-[1.7rem] lg:text-[2.1rem] xl:text-[2.5rem] font-bold"
                    >{MainHeading2}</h2>
                </div>

                {
                    PageName === "home" ?
                        <div className="relative w-full max-xs:h-[22vh] h-[28%] md:h-[28%] bg-bg2 rounded-md flex max-xs:flex-col justify-around items-center max-xs:gap-[6%] sm:gap-[2%] p-[2%] text-text1 max-xs:text-[2.2vw] text-[0.8rem] md:text-[0.8rem] lg:text-[1.05rem] xl:text-[1.2rem]">
                            <p className="absolute left-0 max-xs:bottom-[125%] sm:bottom-[120%] text-text1 max-xs:text-[2.5vw] text-[0.8rem] md:text-[0.8rem] lg:text-[1rem] xl:text-[1.2rem] opacity-90
                    "
                            >Select your next step with our team. Get in touch for:</p>
                            <button
                        ...
                        : PageName === "constrution" ?
                            ...
                            "
                                ...
                                <button
                                    className="w-[98%] font-medium h-full max-xs:rounded-sm ms:rounded-md bg-btn2 drop-shadow-[4px_10px_2px_rgba(0,0,0,0.2)] max-xs:drop-shadow-[2px_5px_2px_rgba(0,0,0,0.4)]
            ...
            <div ref={textRef} className="flex max-xs:gap-2 gap-10 md:gap-10 h-[35%] items-center max-xs:text-[8vw] text-[6rem] md:text-[6rem] lg:text-[7.5rem] xl:text-[8rem] max-xs:font-bold md:font-medium">
