...
const PeoplePage = () => {
    ...
    return (
        <div className="people-page-main bg-bg1 relative">
            ...
            >
                <div
                    className='absolute z-4 bg-[linear-gradient(90deg,rgba(237,237,237,1)_45%,rgba(255,255,255,1)_51%)] max-xs:hidden
                ...
                />
                <div
                    className='absolute w-full h-full z-0 bg-[linear-gradient(90deg,rgba(237,237,237,1)_45%,rgba(255,255,255,1)_51%)] rounded-full blur-[50px] max-xs:hidden'
                    style={{
                        left: `${coords.x - value.x}px`,
                        top: `${((coords.y - value.y))}px`,
                        objectPosition: "center",
                ...
                <div
                    className="absolute left-[28%] max-xxs:top-[-20%] max-xs:top-[-25%] top-[-18%] w-[46%] aspect-2/2 bg-[linear-gradient(90deg,rgba(237,237,237,1)_45%,rgba(255,255,255,1)_51%)] 
